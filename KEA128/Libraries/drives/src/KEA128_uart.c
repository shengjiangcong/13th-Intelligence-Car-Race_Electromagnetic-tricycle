...
void Uart_send()
{
  static uint8 Uart_count=0;
  Uart_count++;
  if(Uart_count>10)
  {
    //USART5_printf("send success !");//发送数据确认串口正常
    uart_putchar(uart2 , 0x03);
    uart_putchar(uart2 , 0xfc); 
    
    //uart_putchar(uart2,(int8)(AnnularFlag));
    //uart_putchar(uart2,(int8)(angle4ms));
   // uart_putchar(uart2,(int8)(anglealltime/100));
	
	
   /*uart_putchar(uart2,(int8)(g_ValueOfAD[0]/50));
	uart_putchar(uart2,(int8)(g_ValueOfAD[1]/50));
	uart_putchar(uart2,(int8)(g_ValueOfAD[2]/50));
	uart_putchar(uart2,(int8)(g_ValueOfAD[3]/50));
	uart_putchar(uart2,(int8)(g_ValueOfAD[4]/50));
	uart_putchar(uart2,(int8)(g_ValueOfAD[5]/50));*/
    uart_putchar(uart2,(int8)(GyroX/100));
	uart_putchar(uart2,(int8)(GyroY/100));
	uart_putchar(uart2,(int8)(L_Speednow/10));
	uart_putchar(uart2,(int8)(R_Speednow/10));
	uart_putchar(uart2,(int8)(Speednow/10));
    uart_putchar(uart2, 0xfc);
    uart_putchar(uart2, 0x03);
    Uart_count=0;
  }
